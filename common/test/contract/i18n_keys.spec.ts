...
describe("completeness", () => {
  ...
  it("records the known gap in the other translations rather than failing", () => {
    ...
    const KNOWN_UNTRANSLATED = [
      ...
      "TXT_CODE_RUNNER_BATCH_NONE_CONTROLLABLE",
      "TXT_CODE_RUNNER_BUSY",
      "TXT_CODE_RUNNER_BATCH_SKIPPED",
      "TXT_CODE_RUNNER_COL_OWNERSHIP",
      "TXT_CODE_RUNNER_COL_SUPERVISOR",
      "TXT_CODE_RUNNER_ENV_SCOPE_LISTENER",
      "TXT_CODE_RUNNER_OWNERSHIP_CONFLICT",
      "TXT_CODE_RUNNER_OWNERSHIP_FOREIGN",
      "TXT_CODE_RUNNER_OWNERSHIP_IDLE",
      "TXT_CODE_RUNNER_OWNERSHIP_SELF",
      "TXT_CODE_RUNNER_OWNERSHIP_UNKNOWN",
      "TXT_CODE_RUNNER_SUPERVISOR_NONE_LABEL",
      "TXT_CODE_RUNNER_SUPERVISOR_PROCESS",
      "TXT_CODE_RUNNER_SUPERVISOR_SYSTEMD",
